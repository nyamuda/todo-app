        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <router-link
                  class="btn btn-primary text-white btn-lg m-2 px-3 px-sm-4 py-sm-2 px-md-5 py-md-3"
                  to="/bookings/add"
                  role="button"
...
const slides = ref([
  {
    title: "Modern Design",
    description:
      "Experience cutting-edge design solutions that blend form and function seamlessly.",
    image:
